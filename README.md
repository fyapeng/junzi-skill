...
Junzi 位于上层，规定人格、方向、主线、主要矛盾、回溯与一般实践纪律；领域技能承接这些要求，形成专门理论、判断与工作流程。两者共同进入任务时保持一条主线，不重复宪章和检查清单。

首个领域专门化项目是 **[Junzi Economist · 君子经济学家](https://github.com/fyapeng/junzi-economist-skill)**：以微观和宏观经济学为“法”，调查现实制度与数据生成之“势”，组织简约式识别、结构分析、计算和写作之“术”与“器”。完整配置应先安装 Junzi，再安装 Junzi Economist。
